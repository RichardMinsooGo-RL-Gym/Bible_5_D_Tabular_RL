...
def run(episodes, is_training=True, render=False):
    ...
    # while(True):
        ...
        while(not terminated and ep_count < 500):
            ...
            if is_training:
                q[s_i0, s_i1, s_i2, action_idx] = \
                    ...
                    learning_rate_a * (
                        reward +
                        discount_factor_g*np.max(q[ns_i0, ns_i1, ns_i2,:])
                        - q[s_i0, s_i1, s_i2, action_idx]
                    )
        ...
        if is_training and i!=0 and (i+1)%100==0:
            ...
            print(f'Episode: {i+1}, Epsilon: {epsilon:0.2f}, Best Reward: {best_reward:0.1f}, Mean Rewards {mean_reward:0.1f}')
            ...
            print(f'Episode: {i+1} Best Reward: {reward:0.1f}')
