...
def run(episodes, is_training=True, render=False):
    ...
    # while(True):
        ...
        if rewards > best_reward:
            ...
            if is_training:
                f = open('MountainCarContinuous.pkl','wb')
                pickle.dump(q, f)
                f.close()
        ...
        if is_training and i!=0 and (i+1)%100==0:
            ...
            print(f'Episode: {i+1}, Epsilon: {epsilon:0.2f}, Last Reward: {rewards:0.1f}, Best Reward: {best_reward:0.1f}, Mean Rewards {mean_reward:0.1f}')
            ...
            print(f'Episode: {i+1} Rewards: {rewards:0.1f}')
